...
# --- CONFIGURAÇÕES PARA O ANO DE 2020 ---

# 1. Caminho para o arquivo de dados original.
caminho_dados_originais = r"D:\FACULDADE_DOMBOSCO\Disciplinas\6_ MODULAR\02-Estagio_Supervisionado_II_IA\projeto_enem\dados_enem\microdados_enem_2020\DADOS\MICRODADOS_ENEM_2020.csv"
...
nome_arquivo_saida = "enem_2020_campo_belo_prova.csv"
...
# 4. Lista de colunas para manter.
colunas_para_manter = [
...
try:
    ...
    print(f"Iniciando processamento para 2020...")
    ...
    if not dados_filtrados_lista:
        ...
        print("-" * 50)
        print("Processo de 2020 finalizado com sucesso!")
    ...
    print(f"ERRO: A coluna {e} não foi encontrada no arquivo CSV de 2020.")
