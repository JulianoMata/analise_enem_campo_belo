...
# --- CONFIGURAÇÕES PARA O ANO DE 2019 ---

# 1. Caminho para o arquivo de dados original.
caminho_dados_originais = r"D:\FACULDADE_DOMBOSCO\Disciplinas\6_ MODULAR\02-Estagio_Supervisionado_II_IA\projeto_enem\dados_enem\microdados_enem_2019\DADOS\MICRODADOS_ENEM_2019.csv"
...
nome_arquivo_saida = "enem_2019_campo_belo_prova.csv"
...
try:
    ...
    print(f"Iniciando processamento para 2019...")
    ...
    if not dados_filtrados_lista:
        ...
        print("-" * 50)
        print("Processo de 2019 finalizado com sucesso!")
