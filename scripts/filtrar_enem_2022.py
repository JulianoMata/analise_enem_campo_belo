...
# --- CONFIGURAÇÕES PARA O ANO DE 2022 ---

# 1. Caminho para o arquivo de dados original de 2022
caminho_dados_originais = r"D:\FACULDADE_DOMBOSCO\Disciplinas\6_ MODULAR\02-Estagio_Supervisionado_II_IA\projeto_enem\dados_enem\microdados_enem_2022\DADOS\MICRODADOS_ENEM_2022.csv"
...
nome_arquivo_saida = "enem_2022_campo_belo_prova.csv"
...
try:
    ...
    print(f"Iniciando processamento para 2022...")
    ...
    if not dados_filtrados_lista:
        ...
        print("-" * 50)
        print("Processo de 2022 finalizado com sucesso!")
